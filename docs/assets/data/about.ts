export const About = [
    {
        ...
        aside: '(That doesn\'t mean so much anymore since it was so long ago \- I just needed to slide that fact in there somewhere.)',
        format: 'image',
        formatSrc: 'img/about/',
        link: '#',
        aWidth: 1000,
    ...
    },
    {
        ...
        aside: 'READ: I remember answering machines, beepers, BBS (Bulletin Board Services) and when the internet was called Mosaic.',
        format: '#',
        formatSrc: 'img/about/',
        link: '#',
        aWidth: 1000,
    ...
    },
    {
        ...
        aside: '(Yes, I see the double entendre... \nI *swear* it was unintentional, and that the statement is true in its purest form. \n#CheekyMonkey.)',
        format: '#',
        formatSrc: 'img/about/',
        link: '#',
        aWidth: 1000,
    ...
    },
    {
        about_index: 8,
        brain: 'right',
        thought: 'I don\'t look like it, but I play a mean game of pool. \n\nIt\'s fun to sneak up on the guy who\'s a bit arrogant about his game... \nthen make best friends with him.',
        aside: '',
        format: '#',
        formatSrc: 'img/about/',
        link: '#',
    ...
    },
    {
        about_index: 9,
        brain: 'right',
        thought: 'I have an off-color sense of humor ranging from that of a 12 year old boy to that of an 80 year old dowager. \n\nIt\'s a gift.',
        aside: '',
        format: '#',
        formatSrc: 'img/about/',
        link: '#',
    ...
    },
    {
        about_index: 13,
        brain: 'right',
        thought: 'The toilet paper roll should *always* feed from the top, and here is why:',
        aside: 'When you try to snap off the amount you want, \nit is likely to over-roll. \nIf the toilet paper feeds from the bottom, there is a 2*PI*r increase in chance that the loose end of the roll will land on the floor. \n\n*** ew. ***',
        format: '#',
        formatSrc: 'img/about/',
        link: '#',
        aWidth: 1000,
